...
export const environment = {
  ...
  _detallesPedidosURL: 'http://localhost:8088/tfg/api/detalles-pedido/',
  ...
  get detallesPedidosURL() {
    return this._detallesPedidosURL;
  },
  set detallesPedidosURL(value) {
    this._detallesPedidosURL = value;
  },
};
